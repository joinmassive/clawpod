...
Sign up at [Massive](https://partners.joinmassive.com/create-account-clawpod) and purchase a residential proxy plan. Get your proxy credentials from the dashboard and set credentials as environment variables:
